        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="card-anime p-6">
            ...
            <ul className="space-y-1.5 text-sm font-body text-card-foreground">
              <li className="flex gap-2"><span className="text-docker-blue">✦</span> Oracle Cloud Foundations</li>
              <li className="flex gap-2"><span className="text-docker-blue">✦</span> IBM Cloud & DevOps</li>
              <li className="flex gap-2"><span className="text-docker-blue">✦</span> Linux Essentials (LPI)</li>
              <li className="flex gap-2"><span className="text-docker-blue">✦</span> SMCE – Scrum Master</li>
            </ul>
          </div>
          ...
          <div className="card-anime p-6">
            ...
            <ul className="space-y-1.5 text-sm font-body text-card-foreground">
              <li className="flex gap-2"><span className="text-docker-blue">★</span> Spanish – Native</li>
              <li className="flex gap-2"><span className="text-k8s-blue">★</span> English – Advanced / Professional</li>
            </ul>
          </div>
        </div>
      </div>
